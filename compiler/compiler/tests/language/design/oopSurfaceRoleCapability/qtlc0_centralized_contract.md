...
Negative proof cases live as real invalid `.qn` files under
...
```text
check qtlang/compiler/tests/language/negative/oopSurfaceRoleCapability/path/to/case.qn --expect-fail
```
